Running 8 parallel SAS processes to conditional subset a dataset into 8 pieces
...
HAVE meta data consisting of year and quarter to create 8 datasets
===================================================================

SD1.META total obs=8
...
Data to split
                              RULES
Obs    YYYY_QTR    VAL     Create these datasets
